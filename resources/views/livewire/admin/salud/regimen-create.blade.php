<div>
    <form wire:submit.prevent="newRegimen">
        ...
        <a href="#" wire:click.prevent="$dispatch('created-regimen')" class="text-black bg-gradient-to-r from-red-300 via-red-400 to-red-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-200 dark:focus:ring-red-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
