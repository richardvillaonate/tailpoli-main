            ...
            @if ($reciboscaja->count()>0)
                    ...
                    <div>
                        @if ($this->numerosedes)
                            <h4 class="text-center text-2xl">
                                Generar cierre para la sede: <strong class="uppercase">{{$unica->name}}</strong>
                            </h4>
                        @else
                            <div class="mb-6">
                                <select wire:model.live="sede_id" wire:change="eligesede" id="sede_id" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 capitalize">
                ...
                <div class="grid sm:grid-cols-1 md:grid-cols-3 gap-4 m-2">
                    @if ($sede_id>0)
                        ...
                        <a href="#" wire:click.prevent="generaCierre" class="text-black bg-gradient-to-r from-cyan-300 via-cyan-400 to-cyan-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mt-2 capitalize">
                            <i class="fa-solid fa-check-double"></i> Generar Cierre
                        </a>
