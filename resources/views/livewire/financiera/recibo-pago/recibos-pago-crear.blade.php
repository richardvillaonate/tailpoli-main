                                    ...
                                    @if ($totalCartera)
                                        ...
                                        @if ($matricula_id>0)
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                                <input 
                                                    wire:model.live="pagado" 
                                                    type="number"
                                                    placeholder=" "
                                                    class="block py-2.5 px-0 w-full text-xs md:text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                />
