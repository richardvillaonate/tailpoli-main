<div>
    <div class="bg-blue-200 rounded-lg align-middle p-2 mb-2 text-center">
        <h1 class="text-xl uppercase">Cursos</h1>
    </div>
            ...
            <table class=" text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('slug')">
                            Código
                            @if ($ordena != 'slug')
                                <i class="fas fa-sort"></i>
                            @else
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('duracion_horas')">
                            Duración Horas
                            @if ($ordena != 'duracion_horas')
                                <i class="fas fa-sort"></i>
                            @else
                                @if ($ordenado=='ASC')
                                    <i class="fas fa-sort-up"></i>
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('duracion_meses')">
                            Duración Meses
                            @if ($ordena != 'duracion_meses')
                                <i class="fas fa-sort"></i>
                            @else
                                @if ($ordenado=='ASC')
                                    <i class="fas fa-sort-up"></i>
