<div>
    <nav class="fixed top-0 z-50 w-full bg-green-300 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-green-200 border-r border-gray-200  dark:bg-gray-800 dark:border-gray-700"
        :class="{
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-green-200 dark:bg-gray-800">
            <ul class="space-y-2 font-medium bg-green-200">
                @foreach ($menus as $item)
                    <li>
                        <x-dropdownPoli align="right" width="48" class="bg-green-200">
                            <x-slot name="trigger" class="bg-green-200">
                                @can($item->permiso)
                            ...
                            <x-slot name="content" class="bg-green-200">
