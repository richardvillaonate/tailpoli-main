<x-imprimir-layout>
    ...
    <div class="relative overflow-x-auto bg-slate-200 shadow-sm shadow-teal-200 m-1">
        ...
        <p class="font-normal m-4 text-gray-700 dark:text-gray-400 text-justify">
            Durante los últimos días hemos venido informandole acerca de la mora que presenta el pago de su curso, en días pasados nuestros sistemas se encargaron de realizar el reporte respectivo a las centrales de riesgo, ver documento anexo.<br>
            Le invitamos a que se comunique con nosotros para eliminar este REPORTE NEGATIVO.
        </p>
        <p class="font-normal m-4 text-gray-700 dark:text-gray-400 text-justify">
